...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('workshop_name', models.CharField(max_length=255, unique=True, verbose_name="Nom de l'atelier")),
                ('quartier', models.CharField(max_length=255, verbose_name='Quartier')),
                ('metier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.metier')),
            ],
        ),
    ]
